...
//   customer1 = new Customer('Mr Smith', 29, 'Pulp', 21.00);
//   customer2 = new Customer('Mrs Johnson', 25, 'Radiohead', 26.00);
//   customer3 = new Customer('Ms Henderson', 41, 'Blur', 6.00);
//   customer4 = new Customer('Mr Bob', 19, 'Blur', 45.00);
//   ricksRecords = new RecordStore('Ricks Records', 'London', 1500);
//   recordStub = {artist: 'Blur', title: 'Parklife', buyPrice: 3, sellPrice: 8.99, quantity: 4}
